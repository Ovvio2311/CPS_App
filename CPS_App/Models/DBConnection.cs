...
namespace CPS_App.Models
{
    ...
    public class MongoDbContext
    {
        ...
        public IMongoCollection<dynamic> DynamicCollection(string collection)
        {
            return _mongoDB.GetCollection<object>(collection);
        }

        public IMongoCollection<BsonDocument> BsonDocumentCollection(string collection)
        {
